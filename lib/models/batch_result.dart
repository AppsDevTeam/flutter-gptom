...
class GpTomBatchResult {
  ...
  Map<String, dynamic> toJson() => {
    ...
    JsonKeys.batchTotalNum: totalCount,
    JsonKeys.batchTotalAmount: totalAmount,
    JsonKeys.batchSaleNum: saleCount,
    JsonKeys.batchSaleAmount: saleAmount,
    JsonKeys.batchVoidNum: voidCount,
    JsonKeys.batchVoidAmount: voidAmount,
